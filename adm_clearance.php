...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <p class="card-title mb-0">Clearance list for <?= $term_syntax?> term |
                        <?= $log_session; ?></p>
                    <div align="right">
                    ...
                    <div class="table-responsive">
                        <table class="myTable table table-striped table-borderless">
                            ...
                            <tbody>
                                <?php while($clr = $clearBills->fetch_object()):
                                    $status = $clr->status;
                                    $your_term = false;
                                ...
                                <tr>
                                    <td><?= $clr->name; ?></td>
                                    <td><?= $clr->adm_no; ?></td>
                                    <td><?= $clr->cleared_by; ?></td>
                                    <td>
                                        <?php if($clr->status == 12): ?>
                                        <?= $status_syntax; ?>
                                        <?php else:?>
                                        <form action="<?= $pusher; ?>" method="post">
                                            <input type="hidden" name="adm_no" value="<?= $clr->adm_no; ?>">
                                            <button type="submit" name="clear_single" class="btn-sm btn-primary">Clear
                                                student</button>
                                        </form>
                                        <?php endif; ?>
                                    </td>
    ...
    <div class="row">
        <div class="col-md-6 stretch-card grid-margin">
            <div class="card">
                <div class="card-body">
                    <p class="card-title mb-0">Clearance uploader</p>
                    <hr>
                    <div class="mt-2">
                        <div class="container">
                            <p>Click the green button to download the student's clearance list as an Excel CSV file.</p>
                            <form action="<?= $exporter; ?>" method="get">
                                <div class="row">
                                    <input type="hidden" name="table" value="<?= $clearance_tbl; ?>">
                        ...
                        <div class="container mt-3">
                            <form action="<?= $pusher;?>" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            <label for="">Choose Clearance Excel File</label>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <button type="submit" name="push_clearance" class="mt-3 btn btn-primary"><i
