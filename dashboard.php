            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <p class="card-title">Course[Subject] Register</p>
                        <a href="#" class="text-info">View all</a>
                    </div>
                    <p class="font-weight-500 text-info">Note that you can only participate in any activity that
                        pertains to
                        the course[subject] you enrol for!
                    </p>
                </div>
                <?php endif; ?>
                        ...
                        <table class="table table-striped table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-danger"><i class="mdi mdi-delete" style="font-size:25px;"></i>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
